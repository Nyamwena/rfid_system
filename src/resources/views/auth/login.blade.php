...
<head>
    ...
    <title>PATIENT RFID SYSTEM - Log in </title>
...
<body class="hold-transition theme-primary bg-img" style="background-image: url({{asset('bg-1.jpg')}})">
                ...
                <div class="col-lg-5 col-md-5 col-12">
                    <div class="bg-white rounded10 shadow-lg">
                        <div class="content-top-agile p-20 pb-0">
                            ...
                            <p class="mb-0">Sign in to continue to Patient RFID System.</p>
                        </div>
                        <div class="p-40">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control ps-15 bg-transparent @error('email') is-invalid @enderror"
                                               placeholder="Username" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                        @error('email')
